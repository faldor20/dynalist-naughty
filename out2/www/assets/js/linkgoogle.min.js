...
!(function () {
  ...
  var c = DYNALIST.SERVER_URL || "https://dynalist.io",
    o = (DYNALIST.PUSH_URL, "/user/login"),
    i = "/user/signup",
    r = "/user/resetpass",
    s = "/loginrequest/create",
    a = "/loginrequest/login",
    u = "/user/forgotpass",
    p = "/feedback",
    l = "/import/workflowy",
    h = "/user/google_login",
  ...
  var E = (function () {
    ...
    T = DYNALIST.SERVICES_URL || "https://dynlst.com",
    O = "/update",
    L = 5e3,
    j = 1.5,
    C = 6e5,
      ...
      return (
        ...
        (t.prototype.track = function (t, e, n) {
          try {
            ...
            (e = e || {}),
              ...
              this.data.push({ type: t, ts: P(), data: e }),
              this.prune(),
        ...
        (t.prototype.push = function () {
          ...
          if (!this.working && 0 !== this.data.length) {
            this.length = Math.min(I, this.data.length);
            var t = this.data.slice(0, this.length);
            this.lz && ((t = JSON.stringify(t)), (t = E.compressToUTF16(t)));
            var n = {
                uid: this.uid,
                ts: this.ts_diff + P(),
                lz: this.lz,
  ...
  DYNALIST.IS_STANDALONE_MODE &&
    ...
    (window.Zousan = Y),
    (DYNALIST.PLATFORM = z);
  var U = new R(DYNALIST.SESSION.identity);
  (window.ghost = U),
    (window.__ = U.track.bind(U)),
  ...
  /(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(
    ...
    ("MacIntel" === navigator.platform &&
      ...
      (/iPad|iPhone|iPod/.test(H) && window.MSStream),
    document.documentElement.style,
    H.toLowerCase().indexOf("firefox"),
    H.toLowerCase().indexOf("edge"),
    -1 !== H.indexOf("Safari") && H.indexOf("Chrome");
  (function t() {
  ...
  var K = "gLogin",
    X = (function () {
      function t() {
        var t = this;
        (this.google_loaded = J()),
          (this.google_error = null),
          this.initialize(),
          window[K].push(function () {
            t.init();
          });
      }
      return (
        (t.prototype.initialize = function () {
          return (
            !!window[K] ||
            ((window[K] = J()),
            Z("https://apis.google.com/js/api:client.js?onload=" + K),
            !1)
          );
        }),
  ...
  var Q = (function () {
          ...
          if (!this.working && 0 !== this.queue.length) {
            ...
            !(function t(e, n, o, r, i) {
              ...
              DYNALIST.IS_STANDALONE_MODE && (a = c + a),
                A && ((i.headers = i.headers || {}), (i.headers.DYS = A)),
                k(
                  a,
                  n,
                  function (t, e, n) {
          ...
          try {
            if (t) {
              ...
              return (
                ...
                t._code === w && this.trigger("network_deprecated"),
                t._code === y && this.trigger("network_logged_out"),
                void (t._code === g ? e && e(t) : n && n(t))
              );
            }
            n && n({ _code: m });
          } catch (t) {
        ...
        B(t, e),
          (t.prototype.login_success = function (t) {
            ...
            this.api_google_login(t.id_token, t.captcha).then(function () {
              e.start_working(), setTimeout(W, 300);
            });
          });
      })(it),
      (function (e) {
    ...
    at = (function (a) {
      function t(t, e, n, o) {
        ...
        if (
          ((r.env = e), (r.success_callback = n), e.is("mobile") && e.is("ios"))
        ) {
          var i = t.get(0),
          ...
          if (!s)
            s = i
              ...
              .parentElement.createEl(
                ...
                function (t) {
                  t.createEl("span", { cls: "signin-icon apple-signin-icon" }),
                    t.createEl("span", { cls: "signin-button-text", text: o });
                },
              );
          ...
          this.clear_messages(),
            o.attempt_apple_login(
              function (t) {
                ...
                e
                  ? (o.set_env_data_nosave("APPLE_NAME", e), o.save_env_data())
