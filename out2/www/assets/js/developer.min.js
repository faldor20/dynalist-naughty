...
!(function () {
    ...
    Array.prototype.every ||
      (Array.prototype.every = function (t, e) {
        ...
        for (1 < arguments.length && (n = e), r = 0; r < i; ) {
          var s = void 0;
          if (r in o) if (((s = o[r]), !t.call(n, s, r, o))) return !1;
          r++;
        }
        return !0;
      }),
  ...
  (Element.prototype.getCtx = function () {
    ...
    (window.createEl = function t(e, n, r) {
      ...
      return (
        i &&
          (Array.isArray(i) ? (f.className = i.join(" ")) : (f.className = i)),
        s && f.setText(s),
        a && f.setAttrs(a),
        u && (f.title = u),
        c &&
          ...
          (f.value = c),
        l && f instanceof HTMLInputElement && (f.type = l),
        r && r(f),
        p && p.appendChild(f),
        f
      );
  ...
  var t = function (t, n, r, e) {
      ...
      i.push({ selector: n, listener: r, options: e, callback: s }),
      ...
      if (t) {
        ...
        e &&
          (t[n] = e.filter(function (t) {
            if (t.selector !== r || t.listener !== o || t.options !== i)
              return !0;
            var e = t.callback;
  ...
  (HTMLElement.prototype.on = t),
    ...
    (window.debounce = function (t, n, r, o, i) {
      var s = null,
        a = null,
        u = null,
        c = !1,
        l = 0,
        p = function () {
          (s = null), i && (l = Date.now()), t.apply(a, u);
        },
        f = function (t, e) {
        ...
        h = function () {
          ...
          if (i) {
            var e = Date.now();
            if (l < e - n) return (l = e), p(), h;
          }
          return f(r, n), h;
        };
      return (
        (h.cancel = function () {
          return s && (clearTimeout(s), (s = null)), h;
        }),
        (h.disable = function () {
          return (c = !0), h;
        }),
        ...
        (h.set_timeout = function (t) {
          return (n = t), s && f(!0, n), h;
        }),
        (h.flush = function () {
          return f(!0, 0), h;
        }),
  ...
  var u = DYNALIST.SERVER_URL || "https://dynalist.io",
    s = (DYNALIST.PUSH_URL, "Ok"),
    a = "NotSignedIn",
    o = "NetError",
    c = "BadResponse",
    l = "Deprecated",
  ...
  var i = (function () {
      ...
      var s = {
          ...
          for (i = 0; i < t.length; i += 1)
            if (
              ...
              if (Object.prototype.hasOwnProperty.call(a, l)) {
                ...
                0 == --p && ((p = Math.pow(2, h)), h++), delete a[l];
              } else
                for (o = s[l], r = 0; r < h; r++)
                  (y = (y << 1) | (1 & o)),
                    g == e - 1 ? ((g = 0), d.push(n(y)), (y = 0)) : g++,
        ...
        _decompress: function (t, e, n) {
          ...
          for (r = c[3] = u, d.push(u); ; ) {
            if (y.index > t) return "";
            for (o = 0, s = Math.pow(2, f), a = 1; a != s; )
              (i = y.val & y.position),
                (y.position >>= 1),
                0 == y.position && ((y.position = e), (y.val = n(y.index++))),
                (o |= (0 < i ? 1 : 0) * a),
            ...
            if ((0 == l && ((l = Math.pow(2, f)), f++), c[u])) h = c[u];
            else {
              if (u !== p) return null;
              h = r + r.charAt(0);
            }
        ...
        (i.decode_url_query = function (t) {
          ...
          for (var n = t.split("&"), r = 0; r < n.length; r++) {
            ...
            if (1 <= o.length && o[0]) {
              ...
              2 === o.length ? (e[i] = decodeURIComponent(o[1])) : (e[i] = !0);
            }
          }
          return e;
        }),
    ...
    y = DYNALIST.SERVICES_URL || "https://dynlst.com",
    g = "/update",
    m = 5e3,
    v = 1.5,
    _ = 6e5,
  ...
  function O() {
    return r.decode_url(window.location.href).query.src || null;
  }
  var j = (function () {
      function t(t) {
        (this.uid = t),
          ...
          (this.lz = !0),
          (this.timer = null),
          (this._request_run = debounce(this.run, m));
      }
      return (
        (t.prototype.request_run = function () {
          var t = Math.pow(v, this.failed) * m;
          _ < t && (t = _),
            (t = Math.floor(t)),
        ...
        (t.prototype.run = function () {
          if (0 !== this.data.length) {
            var t = k();
            this.ts < t - w ? this.refresh() : this.push();
          }
        }),
        ...
        (t.prototype.track = function (t, e, n) {
          try {
            ...
            (e = e || {}),
              ...
              this.data.push({ type: t, ts: k(), data: e }),
              this.prune(),
        ...
        (t.prototype.prune = function () {
          if (!(this.data.length < A)) {
            ...
            0 < e && this.data.splice(0, e),
              this.data.length > E && this.data.splice(0, this.data.length - E);
          }
        }),
        (t.prototype.push = function () {
          var e = this;
          if (!this.working && 0 !== this.data.length) {
            this.length = Math.min(T, this.data.length);
            var t = this.data.slice(0, this.length);
            this.lz && ((t = JSON.stringify(t)), (t = i.compressToUTF16(t)));
            var n = {
                uid: this.uid,
                ts: this.ts_diff + k(),
                lz: this.lz,
          ...
          resolve: function (n) {
            if (this.state === s) {
              ...
              (this.state = u),
                ...
                r.c &&
                  c(function () {
                    for (var t = 0, e = r.c.length; t < e; t++) p(r.c[t], n);
                  });
            }
          },
          reject: function (n) {
            if (this.state === s) {
              ...
              r
                ? c(function () {
                    for (var t = 0, e = r.length; t < e; t++) f(r[t], n);
                  })
  ...
  DYNALIST.IS_STANDALONE_MODE &&
    ((N = "desktop"),
    window.process && window.process.platform && (N = window.process.platform)),
    (window.Zousan = C),
    (DYNALIST.PLATFORM = N);
  var L = new j(DYNALIST.SESSION.identity);
  (window.ghost = L),
    (window.__ = L.track.bind(L)),
  ...
  var I = (function () {
          ...
          (e = this.events).trigger.apply(
            ...
            (function t() {
              ...
              var o = Array(e),
                i = 0;
              for (n = 0; n < r; n++)
                for (var s = arguments[n], a = 0, u = s.length; a < u; a++, i++)
                  o[i] = s[a];
              return o;
            })([t], n),
          );
      ...
      return (
        ...
        (t.prototype.off = function (t, e) {
          var n = this._,
            ...
            o = [];
          if (r && e)
            for (var i = 0; i < r.length; i++) r[i].fn !== e && o.push(r[i]);
          0 < o.length ? (n[t] = o) : delete n[t];
        }),
        (t.prototype.offref = function (t) {
          if (t) {
            var e = t.name,
              ...
              o = [];
            if (r && t)
              for (var i = 0; i < r.length; i++) r[i] !== t && o.push(r[i]);
            o.length ? (n[e] = o) : delete n[e];
          }
        }),
        (t.prototype.trigger = function (t) {
          ...
          if (!this.disabled) {
            ...
            if (r) {
              r = r.slice();
              for (var o = 0; o < r.length; o++) this.tryTrigger(r[o], e);
            }
          }
        }),
    ...
    x = (function (n) {
      ...
      return (
        ...
        (t.prototype.enqueue = function (t, e, n, r, o) {
        ...
        (t.prototype.run = function () {
          ...
          if (!this.working && 0 !== this.queue.length) {
            ...
            !(function t(e, n, r, o, i) {
              ...
              var a = "/api" + e;
              DYNALIST.IS_STANDALONE_MODE && (a = u + a),
                d && ((i.headers = i.headers || {}), (i.headers.DYS = d)),
                h(
                  a,
                  n,
                  function (t, e, n) {
              ...
              n,
              function (t) {
                return r.handle_response(t, o, i);
              },
              function (t, e, n) {
                return r.handle_error(e, i);
              },
              s,
            );
          }
        ...
        (t.prototype.handle_response = function (t, e, n) {
          ...
          try {
            if (t) {
              var r = t._mv,
                o = DYNALIST.VERSION;
              o && r && o < r && this.trigger("network_deprecated");
              var i = t._b;
              return (
                i &&
                  this.build !== i &&
                  ((this.build = i), this.trigger("build_changed", i)),
                t._code === l && this.trigger("network_deprecated"),
  ...
  new ((function () {
    function t() {
      (this.network = new x()), (this.modal_manager = null);
    }
    return (
      (t.prototype.init = function () {
        this.pull_developer_info(),
          this.init_modal_manager(),
          this.register_listeners();
      }),
      (t.prototype.register_listeners = function () {
        var e = this,
          t = fish(".js-generate-token"),
          n = fish(".js-open-destroy-token"),
          r = fish(".js-confirm-destroy-token");
        t.addEventListener("click", function () {
          e.net_generate_token(function (t) {
            t.token &&
              (e.fill_in_token(t.token),
              fish(".account-setting-row.mod-no-api-token").uHide(),
              fish(".account-setting-row.mod-has-api-token").uShow());
          }, e.display_error.bind(e));
        }),
          n.addEventListener("click", function () {
            e.modal_manager.open_modal("confirm-destroy-token");
          }),
          r.addEventListener("click", function () {
            e.net_delete_token(function () {
              window.location.reload();
            }, e.display_error.bind(e));
          });
      }),
      (t.prototype.init_modal_manager = function () {
        var t = this;
        (this.modal_manager = new D()),
          $(".close-btn, .modal-bg, .js-cancel").on("click", function () {
            t.modal_manager.close_modal();
          });
      }),
      (t.prototype.pull_developer_info = function () {
        var e = this;
        this.net_get_token(function (t) {
          t.token
            ? (e.fill_in_token(t.token),
              fish(".account-setting-row.mod-no-api-token").uHide())
            : fish(".account-setting-row.mod-has-api-token").uHide();
        }, this.display_error.bind(this));
      }),
      (t.prototype.fill_in_token = function (t) {
        fish(".api-secret-string").setText(t);
      }),
      (t.prototype.display_error = function (t) {
        fish(".GenericError-title").setText("Error"),
          fish(".GenericError-message").setText(t || "Something went wrong!"),
          this.modal_manager.open_modal("generic-error");
      }),
      (t.prototype.net_get_token = function (e, n) {
        this.network.enqueue(
          ...
          function (t) {
            var e = "";
            t && t._msg && (e = t._msg), n && n(e);
          },
        );
      }),
      (t.prototype.net_generate_token = function (e, n) {
        this.network.enqueue(
          "/developer/gentoken",
          {},
          function (t) {
      ...
      (t.prototype.net_delete_token = function (t, n) {
        this.network.enqueue(
          "/developer/deltoken",
          {},
          function () {
