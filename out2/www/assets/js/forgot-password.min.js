...
!(function () {
  ...
  (HTMLElement.prototype.on = t),
    ...
    (window.debounce = function (t, n, r, o, i) {
      var s = null,
        ...
        p = 0,
        l = function () {
          (s = null), i && (p = Date.now()), t.apply(a, u);
        },
        h = function (t, e) {
  ...
  var O = (function () {
      ...
      var s = {
            ...
            if (
              ...
              if (Object.prototype.hasOwnProperty.call(a, p)) {
                if (p.charCodeAt(0) < 256) {
                  ...
                  for (o = p.charCodeAt(0), r = 0; r < 8; r++)
                    (y = (y << 1) | (1 & o)),
                      g == e - 1 ? ((g = 0), d.push(n(y)), (y = 0)) : g++,
                      (o >>= 1);
                } else {
                  for (o = 1, r = 0; r < f; r++)
                    (y = (y << 1) | o),
                      g == e - 1 ? ((g = 0), d.push(n(y)), (y = 0)) : g++,
                      (o = 0);
                  for (o = p.charCodeAt(0), r = 0; r < 16; r++)
                    (y = (y << 1) | (1 & o)),
                      g == e - 1 ? ((g = 0), d.push(n(y)), (y = 0)) : g++,
                      (o >>= 1);
                }
        ...
        _decompress: function (t, e, n) {
          ...
          for (r = c[3] = u, d.push(u); ; ) {
            ...
            if ((0 == p && ((p = Math.pow(2, h)), h++), c[u])) f = c[u];
            else {
              if (u !== l) return null;
              f = r + r.charAt(0);
            }
    ...
    j = DYNALIST.SERVICES_URL || "https://dynlst.com",
    q = "/update",
    N = 5e3,
    L = 1.5,
    M = 6e5,
  ...
  var H = (function () {
      function t(t) {
        (this.uid = t),
          ...
          (this.lz = !0),
          (this.timer = null),
          (this._request_run = debounce(this.run, N));
      }
      return (
        (t.prototype.request_run = function () {
          var t = Math.pow(L, this.failed) * N;
          M < t && (t = M),
            (t = Math.floor(t)),
        ...
        (t.prototype.run = function () {
          if (0 !== this.data.length) {
            var t = P();
            this.ts < t - I ? this.refresh() : this.push();
          }
        }),
        ...
        (t.prototype.prune = function () {
          if (!(this.data.length < D)) {
            ...
            0 < e && this.data.splice(0, e),
              this.data.length > F && this.data.splice(0, this.data.length - F);
          }
        }),
        (t.prototype.push = function () {
          var e = this;
          if (!this.working && 0 !== this.data.length) {
            this.length = Math.min(R, this.data.length);
            var t = this.data.slice(0, this.length);
            this.lz && ((t = JSON.stringify(t)), (t = O.compressToUTF16(t)));
            var n = {
                uid: this.uid,
                ts: this.ts_diff + P(),
                lz: this.lz,
          ...
          resolve: function (n) {
            if (this.state === s) {
              ...
              (this.state = u),
                ...
                r.c &&
                  c(function () {
                    for (var t = 0, e = r.c.length; t < e; t++) l(r.c[t], n);
                  });
            }
          },
          reject: function (n) {
  ...
  DYNALIST.IS_STANDALONE_MODE &&
    ...
    (window.Zousan = V),
    (DYNALIST.PLATFORM = z);
  var B = new H(DYNALIST.SESSION.identity);
  (window.ghost = B),
    (window.__ = B.track.bind(B)),
          ...
          if (!this.working && 0 !== this.queue.length) {
            ...
            !(function t(e, n, r, o, i) {
              ...
              DYNALIST.IS_STANDALONE_MODE && (a = u + a),
                S && ((i.headers = i.headers || {}), (i.headers.DYS = S)),
                T(
                  a,
                  n,
                  function (t, e, n) {
          ...
          try {
            if (t) {
              ...
              return (
                ...
                t._code === A && this.trigger("network_deprecated"),
                t._code === v && this.trigger("network_logged_out"),
                void (t._code === w ? e && e(t) : n && n(t))
              );
            }
            n && n({ _code: b });
          } catch (t) {
  ...
  var G = "gRecaptcha",
    ...
    Q = (function (n) {
      function t(t) {
        ...
        return (
          (e.forgot_password_btn = e.container.find(".js-request-reset")),
          (e.email_field = e.container.find(".EmailField")),
          e.captcha.load_captcha_when_ready(),
          e.forgot_password_btn.on("click", function (t) {
            t.preventDefault(), e.forgot_password();
          }),
          e.email_field.on("keydown", function (t) {
            t.keyCode === i && (t.preventDefault(), e.forgot_password());
          }),
          e
        );
      }
      return (
        e(t, n),
        (t.prototype.forgot_password = function () {
          var t = this;
          if (!this.working) {
            var e = this.email_field.val(),
              n = this.try_get_captcha();
            this.api_forgot_password(e, n).then(function () {
      ...
      (function () {
        ...
        return (
          ...
          (t.prototype.api_enqueue = function (t, e, n, r) {
            var o = this;
            ...
            return (
              this.network.enqueue(
                ...
                e,
                function (t) {
                  o.end_working(), i.resolve(t);
                },
                function (t) {
                  o.end_working(),
                    t && t._captcha && o.try_load_captcha(),
                    o.show_response_error_message(t, n),
                    i.reject(t);
                },
                r,
              ),
          ...
          (t.prototype.api_signup = function (t, e, n, r, o) {
            return this.api_enqueue(
              a,
              {
                name: t,
          ...
          (t.prototype.api_apple_signup = function (t, e, n, r) {
            return this.api_enqueue(
              a,
              { apple_id_token: t, apple_auth_code: e, name: n, captcha: r },
              "Failed to signup.",
            );
          }),
