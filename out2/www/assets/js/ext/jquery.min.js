...
!(function () {
  var e = (function (e) {
          ...
          if (d.qsa && !S[e + " "] && (!v || !v.test(e))) {
            if (1 !== p) (f = t), (c = e);
              ...
              for (
                ...
                l[o] = "#" + s + " " + me(l[o]);
              (c = l.join(",")), (f = (Q.test(e) && ge(t.parentNode)) || t);
            }
            if (c)
              try {
          ...
          se(function (e, t, n, r) {
            var i,
              ...
              c =
                e ||
                (function e(t, n, r) {
                  for (var i = 0, o = n.length; i < o; i++) oe(t, n[i], r);
                  return r;
                })(h || "*", n.nodeType ? [n] : n, []),
              ...
              for (
                ...
                if (
                  ...
                  (r = u(
                    ...
                    (Q.test(o[0].type) && ge(t.parentNode)) || t,
                  ))
                ) {
    ...
    (E.Callbacks = function (r) {
      ...
      E.extend({
            ...
            a = {
              ...
              then: function (t, n, r) {
                      ...
                      e = function () {
                        ...
                        if (!(i < u)) {
                          ...
                          (t =
                            ...
                            E.isFunction(t)
                              ? s
                                ? t.call(e, l(u, o, O, s), l(u, o, P, s))
                                : (u++,
                                  t.call(
                                    e,
                                    l(u, o, O, s),
                                    l(u, o, P, s),
                                    l(u, o, O, o.notifyWith),
                                  ))
                              : (a !== O && ((n = void 0), (r = [e])),
                                (s || o.resolveWith)(n, r));
                        }
                ...
                return E.Deferred(function (e) {
                  o[0][3].add(l(0, e, E.isFunction(r) ? r : O, e.notifyWith)),
                    o[1][3].add(l(0, e, E.isFunction(t) ? t : O)),
                    o[2][3].add(l(0, e, E.isFunction(n) ? n : P));
                }).promise();
              },
              promise: function (e) {
        ...
        when: function (e) {
          ...
          if (
            n <= 1 &&
            (R(e, o.done(a(t)).resolve, o.reject),
            "pending" === o.state() || E.isFunction(i[t] && i[t].then))
          )
            return o.then();
          for (; t--; ) R(i[t], a(t), o.reject);
          return o.promise();
        },
      });
    ...
    function W() {
      C.removeEventListener("DOMContentLoaded", W),
        window.removeEventListener("load", W),
        E.ready();
    }
          ...
          if (
            ...
            for (t = a.length; t--; )
              a[t] &&
                ...
                ((r = E.camelCase(r.slice(5))), G(o, r, i[r]));
              ...
              "" === r.style.display &&
                ...
                (l[c] =
                  ...
                  (u = te[s]) ||
                    ...
                    "none" === u && (u = "block"),
                    (te[s] = u)))))
            : "none" !== n && ((l[c] = "none"), X.set(r, "display", n)));
    ...
    (le = C.createDocumentFragment().appendChild(C.createElement("div"))),
    ...
    function Ae(n, r, i, o) {
      ...
      var e,
        ...
        d = r[0],
        h = E.isFunction(d);
      if (h || (1 < f && "string" == typeof d && !v.checkClone && Ce.test(d)))
      ...
      if (
        ...
        for (s = (a = E.map(se(e, "script"), Se)).length; c < f; c++)
          (u = e),
            c !== p &&
              ((u = E.clone(u, !0, !0)), s && E.merge(a, se(u, "script"))),
            i.call(n[c], u, c);
        if (s)
          for (
            l = a[a.length - 1].ownerDocument, E.map(a, De), c = 0;
            c < s;
            c++
          )
            (u = a[c]),
              oe.test(u.type || "") &&
                ...
                (u.src
                  ...
                  : m(u.textContent.replace(ke, ""), l));
      }
      return n;
    }
    function qe(e, t, n) {
      for (var r, i = t ? E.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
        n || 1 !== r.nodeType || E.cleanData(se(r)),
          r.parentNode &&
            (n && E.contains(r.ownerDocument, r) && ue(se(r, "script")),
    ...
    E.extend({
      ...
      clone: function (e, t, n) {
        ...
        if (
          ...
          for (a = se(c), r = 0, i = (o = se(e)).length; r < i; r++)
            (s = o[r]),
              (u = a[r]),
              void 0,
              "input" === (l = u.nodeName.toLowerCase()) && re.test(s.type)
                ? (u.checked = s.checked)
                : ("input" !== l && "textarea" !== l) ||
        ...
        return (
          0 < (a = se(c, "script")).length && ue(a, !f && se(e, "script")), c
        );
      },
      ...
      E.fn.extend({
        ...
        empty: function () {
          for (var e, t = 0; null != (e = this[t]); t++)
            1 === e.nodeType && (E.cleanData(se(e, !1)), (e.textContent = ""));
          return this;
        },
        clone: function (e, t) {
          return (
          ...
          return B(
            ...
            function (e) {
              ...
              if (
                "string" == typeof e &&
                !Te.test(e) &&
                !ae[(ie.exec(e) || ["", ""])[1].toLowerCase()]
              ) {
                e = E.htmlPrefilter(e);
                try {
                  for (; n < r; n++)
                    1 === (t = this[n] || {}).nodeType &&
                      (E.cleanData(se(t, !1)), (t.innerHTML = e));
                  t = 0;
                } catch (e) {}
              }
        ...
        replaceWith: function () {
          ...
          return Ae(
            ...
            function (e) {
              ...
              E.inArray(this, n) < 0 &&
                (E.cleanData(se(this)), t && t.replaceChild(e, this));
            },
            n,
          );
        },
    ...
    function Xe(e, t, n, r, i) {
      ...
      for (
        ...
        "margin" === n && (a += E.css(e, n + K[o], !0, i)),
          r
            ? ("content" === n && (a -= E.css(e, "padding" + K[o], !0, i)),
              "margin" !== n &&
                (a -= E.css(e, "border" + K[o] + "Width", !0, i)))
            : ((a += E.css(e, "padding" + K[o], !0, i)),
              "padding" !== n &&
                (a += E.css(e, "border" + K[o] + "Width", !0, i)));
      return a;
    }
    function ze(e, t, n) {
      ...
      if (
        ...
        if (
          (((r = Oe(e, t, o)) < 0 || null == r) && (r = e.style[t]), He.test(r))
        )
          return r;
    ...
    E.extend({
      ...
      style: function (e, t, n, r) {
        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
          var i,
            ...
            u = e.style;
          if (
            ((t = E.cssProps[s] || (E.cssProps[s] = $e(s) || s)),
      ...
      E.each(["height", "width"], function (e, a) {
        E.cssHooks[a] = {
          get: function (e, t, n) {
            if (t)
              return !Re.test(E.css(e, "display")) ||
          ...
          set: function (e, t, n) {
            var r,
              ...
              o =
                n &&
                Xe(e, a, n, "border-box" === E.css(e, "boxSizing", !1, i), i);
            return (
              o &&
                (r = J.exec(t)) &&
                "px" !== (r[3] || "px") &&
      ...
      E.each({ margin: "", padding: "", border: "Width" }, function (i, o) {
        (E.cssHooks[i + o] = {
          ...
          Le.test(i) || (E.cssHooks[i + o].set = _e);
      }),
      E.fn.extend({
        css: function (e, t) {
          return B(
    ...
    var Ve,
      ...
      Qe = /queueHooks$/;
    function Ze() {
      Ge && (window.requestAnimationFrame(Ze), E.fx.tick());
    }
    function et() {
      return (
        window.setTimeout(function () {
    ...
    function nt(e, t, n) {
      for (
        var r,
          i = (rt.tweeners[t] || []).concat(rt.tweeners["*"]),
          o = 0,
          a = i.length;
        o < a;
        o++
    ...
    function rt(o, e, t) {
      ...
      for (
        ...
        if ((n = rt.prefilters[r].call(l, o, c, l.opts)))
          return (
            E.isFunction(n.stop) &&
    ...
    (E.Animation = E.extend(rt, {
      ...
      tweener: function (e, t) {
        for (
          var n,
            r = 0,
            i = (e = E.isFunction(e) ? ((t = e), ["*"]) : e.match(F)).length;
          r < i;
          r++
        )
          (n = e[r]),
      ...
      prefilters: [
        function e(t, n, r) {
          ...
          if ((l = !E.isEmptyObject(n)) || !E.isEmptyObject(h))
            for (i in (p &&
              1 === t.nodeType &&
            ...
            h))
              l ||
                (m
                  ...
                  : (m = X.access(t, "fxshow", { display: c })),
                a && (m.hidden = !v),
                v && ne([t], !0),
                d.done(function () {
                  for (i in (v || ne([t]), X.remove(t, "fxshow"), h))
                    E.style(t, i, h[i]);
                })),
                (l = nt(v ? m[i] : 0, i, d)),
                i in m ||
        ...
        stop: function (i, e, o) {
          ...
          return (
            ...
            this.each(function () {
              ...
              else for (t in r) r[t] && r[t].stop && Qe.test(t) && a(r[t]);
              for (t = n.length; t--; )
                n[t].elem !== this ||
                  (null != i && n[t].queue !== i) ||
      ...
      (E.fx.tick = function () {
        var e,
          t = 0,
          n = E.timers;
        for (Ve = E.now(); t < n.length; t++)
          (e = n[t])() || n[t] !== e || n.splice(t--, 1);
        n.length || E.fx.stop(), (Ve = void 0);
      }),
      ...
      (E.fx.start = function () {
        Ge ||
          (Ge = window.requestAnimationFrame
            ...
            : window.setInterval(E.fx.tick, E.fx.interval));
      }),
      (E.fx.stop = function () {
      ...
      (Je = C.createElement("select").appendChild(C.createElement("option"))),
      (Ye.type = "checkbox"),
      (v.checkOn = "" !== Ye.value),
      (v.optSelected = Je.selected),
      ((Ye = C.createElement("input")).value = "t"),
      (Ye.type = "radio"),
      (v.radioValue = "t" === Ye.value);
    var it,
      ot = E.expr.attrHandle;
    E.fn.extend({
      attr: function (e, t) {
            ...
            return void 0 === e.getAttribute
              ...
              : ((1 === o && E.isXMLDoc(e)) ||
                  (i =
                    ...
                    (E.expr.match.bool.test(t) ? it : void 0)),
                void 0 !== n
                  ? null === n
    ...
    E.fn.extend({
        ...
        propHooks: {
          tabIndex: {
            get: function (e) {
              ...
              return t
                ? parseInt(t, 10)
                : at.test(e.nodeName) || (st.test(e.nodeName) && e.href)
                ? 0
                : -1;
            },
          },
      ...
      E.fn.extend({
        addClass: function (t) {
          ...
          if (E.isFunction(t))
            return this.each(function (e) {
              E(this).addClass(t.call(this, e, lt(this)));
            });
        ...
        removeClass: function (t) {
          ...
          if (E.isFunction(t))
            return this.each(function (e) {
              E(this).removeClass(t.call(this, e, lt(this)));
            });
        ...
        toggleClass: function (i, t) {
          ...
          return "boolean" == typeof t && "string" == o
            ...
            ? this.each(function (e) {
                E(this).toggleClass(i.call(this, e, lt(this), t), t);
              })
            : this.each(function () {
                var e, t, n, r;
                if ("string" == o)
                  for (t = 0, n = E(this), r = i.match(F) || []; (e = r[t++]); )
                    n.hasClass(e) ? n.removeClass(e) : n.addClass(e);
                else
                  (void 0 !== i && "boolean" != o) ||
                    ((e = lt(this)) && X.set(this, "__className__", e),
                    this.setAttribute &&
                      this.setAttribute(
                        "class",
        ...
        hasClass: function (e) {
          var t,
            ...
            r = 0;
          for (t = " " + e + " "; (n = this[r++]); )
            if (1 === n.nodeType && -1 < (" " + ut(lt(n)) + " ").indexOf(t))
              return !0;
          return !1;
        },
      });
        ...
        if (
          ...
          if (!r && !c.noBubble && !E.isWindow(n)) {
            for (
              ...
              f.push(o), (a = o);
            a === (n.ownerDocument || C) &&
              f.push(a.defaultView || a.parentWindow || window);
          }
    ...
    (jt.href = pt.href),
      E.extend({
        ...
        ajaxSetup: function (e, t) {
          return t ? Lt(Lt(e, E.ajaxSettings), t) : Lt(E.ajaxSettings, e);
        },
        ajaxPrefilter: At(Nt),
        ajaxTransport: At(St),
        ajax: function (e, t) {
          ...
          if (
            ...
            (v.dataTypes = (v.dataType || "*").toLowerCase().match(F) || [""]),
            null == v.crossDomain)
          ) {
            r = C.createElement("a");
            try {
          ...
          if (
            (v.data &&
              ...
              (v.data = E.param(v.data, v.traditional)),
            qt(Nt, v, t, T),
            h)
          )
            return T;
          for (i in ((g = E.event && v.global) &&
            0 == E.active++ &&
            E.event.trigger("ajaxStart"),
          (v.type = v.type.toUpperCase()),
          (v.hasContent = !Et.test(v.type)),
          (f = v.url.replace(wt, "")),
          v.hasContent
            ? v.data &&
              v.processData &&
          ...
          function l(e, t, n, r) {
            ...
            h ||
              ...
              (w = void 0),
              g &&
                y.trigger(i ? "ajaxSuccess" : "ajaxError", [T, v, i ? o : a]),
              b.fireWith(m, [T, l]),
              g &&
    ...
    return (
      ...
      E.ajaxPrefilter("json jsonp", function (e, t, n) {
        ...
        if (a || "jsonp" === e.dataTypes[0])
          return (
            ...
            n.always(function () {
              void 0 === i ? E(window).removeProp(r) : (window[r] = i),
      ...
      (v.createHTMLDocument =
        (((Ot = C.implementation.createHTMLDocument("").body).innerHTML =
          "<form></form><form></form>"),
      ...
      (E.fn.load = function (e, t, n) {
        var r,
          ...
          s = e.indexOf(" ");
        return (
          -1 < s && ((r = ut(e.slice(s))), (e = e.slice(0, s))),
          E.isFunction(t)
            ? ((n = t), (t = void 0))
      ...
      E.each(["top", "left"], function (e, n) {
        E.cssHooks[n] = Pe(v.pixelPosition, function (e, t) {
          if (t)
            return (t = Oe(e, n)), He.test(t) ? E(e).position()[n] + "px" : t;
        });
      }),
  ...
  !(function e(t, n) {
    (window.EXT = window.EXT || {}), (window.EXT[t] = n);
  })("jquery", e),
    (e.event.special.touchmove = {
      setup: function (e, t, n) {
        try {
          if (!t.includes("preventDefault")) return !1;
          this.addEventListener("touchmove", n, { passive: !1 });
        } catch (e) {
          return !1;
        }
      },
