...
!(function () {
  var t = (function () {
      ...
      return (
        (t.prototype.displayTooltip = function (t, e, n, o, r) {
          if (this.parentEl !== t) {
            this.hideTooltip();
            ...
            "bottom" === n
              ? ((u = s + c + r), (p = a + l / 2))
              : "right" === n
              ? ((u = s + c / 2), (p = a + l + r), d.push("mod-right"))
              : "left" === n
              ? ((u = s + c / 2), (p = a - r), d.push("mod-left"))
              : "top" === n &&
                ((u = s - r - 5), (p = a + l / 2), d.push("mod-top")),
              h.addClasses(d),
              (h.style.top = "0px"),
              (h.style.left = "0px"),
              (h.style.width = ""),
            ...
            var y = h.getBoundingClientRect(),
              m = ["bottom", "top"].contains(n) ? y.width / 2 : y.width,
              g = "right" === n || "left" === n ? y.height / 2 : y.height;
            if (
              ("left" === n ? (p -= m) : "top" === n && (u -= g),
              u + g > window.innerHeight && (u = window.innerHeight - g - r),
              (u = Math.max(u, r)),
              "top" === n || "bottom" === n)
            ) {
              if (p + m > window.innerWidth)
                (p -= v = p + m + r - window.innerWidth),
                  (f.style.left = "initial"),
                  (f.style.right = m - v - r / 2 + "px");
              else if (p - r - m < 0) {
                var v;
                (p += v = -(p - r - m)),
                  (f.style.right = "initial"),
                  (f.style.left = m - v - r / 2 + "px");
              }
              p = Math.max(p, r);
            }
            (h.style.top = u + "px"),
        ...
        (t.prototype.onDisplayTooltip = function (t, e) {
          ...
          e.hasAttribute("aria-label-position") &&
            ...
            e.hasAttribute("aria-label-classes") &&
              (r = e.getAttribute("aria-label-classes").split(" ")),
            this.displayTooltip(e, n, o, r);
        }),
    ...
    l =
      ...
      DYNALIST.SERVER_HOST,
      DYNALIST.SERVER_URL || "https://dynalist.io"),
    o = (DYNALIST.PUSH_URL, "pro-monthly"),
    r = "pro-yearly",
    s = "Ok",
    a = "NotSignedIn",
    i = "NetError",
  ...
  Function.prototype.bind ||
    ...
    Array.prototype.every ||
      (Array.prototype.every = function (t, e) {
        ...
        for (1 < arguments.length && (n = e), o = 0; o < i; ) {
          var s = void 0;
          if (o in r) if (((s = r[o]), !t.call(n, s, o, r))) return !1;
          o++;
        }
        return !0;
      }),
    Array.prototype.some ||
      (Array.prototype.some = function (t) {
        ...
        for (
          ...
          if (r in e && t.call(o, e[r], r, e)) return !0;
        return !1;
      }),
  ...
  (Element.prototype.getCtx = function () {
    ...
    (window.createEl = function t(e, n, o) {
      ...
      return (
        i &&
          (Array.isArray(i) ? (h.className = i.join(" ")) : (h.className = i)),
        s && h.setText(s),
        a && h.setAttrs(a),
        l && (h.title = l),
        c &&
          ...
          (h.value = c),
        u && h instanceof HTMLInputElement && (h.type = u),
        o && o(h),
        p && p.appendChild(h),
        h
      );
    });
  var n = function (t, n, o, e) {
      var r = this._DYNALIST_EVENTS;
      r || ((r = {}), (this._DYNALIST_EVENTS = r));
      var i = r[t];
      i || ((i = []), (r[t] = i));
      var s = function (t) {
      ...
      i.push({ selector: n, listener: o, options: e, callback: s }),
      ...
      if (t) {
        ...
        e &&
          (t[n] = e.filter(function (t) {
            if (t.selector !== o || t.listener !== r || t.options !== i)
              return !0;
            var e = t.callback;
            return s.removeEventListener(n, e, i), !1;
          }));
      }
    };
  (HTMLElement.prototype.on = n),
    (Document.prototype.on = n),
    ...
    (window.each = function (t, e, n, o) {
      if (isArrayLike(t)) {
        ...
        for (var i in t)
          if (t.hasOwnProperty(i) && !1 === e.call(n, t[i], i, t)) return !1;
      return !0;
    }),
    (window.each_reverse = function (t, e, n) {
      return each(t, e, n, !0);
    }),
    (window.debounce = function (t, n, o, r, i) {
      var s = null,
        a = null,
        l = null,
        c = !1,
        u = 0,
        p = function () {
          (s = null), i && (u = Date.now()), t.apply(a, l);
        },
        h = function (t, e) {
        ...
        f = function () {
          ...
          if (!s || r) {
            (a = this), (l = []);
            for (var t = 0; t < arguments.length; t++) l.push(arguments[t]);
          }
          if (i) {
            var e = Date.now();
            if (u < e - n) return (u = e), p(), f;
          }
          return h(o, n), f;
        };
      return (
      ...
      var s = {
          ...
          for (i = 0; i < t.length; i += 1)
            if (
              ...
              if (Object.prototype.hasOwnProperty.call(a, u)) {
                ...
                0 == --p && ((p = Math.pow(2, f)), f++), delete a[u];
              } else
                for (r = s[u], o = 0; o < f; o++)
                  (y = (y << 1) | (1 & r)),
                    m == e - 1 ? ((m = 0), d.push(n(y)), (y = 0)) : m++,
        ...
        _decompress: function (t, e, n) {
          var o,
            ...
            f = "",
            d = [],
            y = { val: n(0), position: e, index: 1 };
          for (r = 0, s = Math.pow(2, 2), a = 1; a != s; )
            (i = y.val & y.position),
              (y.position >>= 1),
              0 == y.position && ((y.position = e), (y.val = n(y.index++))),
              (r |= (0 < i ? 1 : 0) * a),
              (a <<= 1);
          switch (r) {
            case 0:
              for (r = 0, s = Math.pow(2, 8), a = 1; a != s; )
                (i = y.val & y.position),
                  (y.position >>= 1),
                  0 == y.position && ((y.position = e), (y.val = n(y.index++))),
                  (r |= (0 < i ? 1 : 0) * a),
              ...
              break;
            case 1:
              for (r = 0, s = Math.pow(2, 16), a = 1; a != s; )
                (i = y.val & y.position),
                  (y.position >>= 1),
                  0 == y.position && ((y.position = e), (y.val = n(y.index++))),
                  (r |= (0 < i ? 1 : 0) * a),
          ...
          for (o = c[3] = l, d.push(l); ; ) {
            if (y.index > t) return "";
            for (r = 0, s = Math.pow(2, h), a = 1; a != s; )
              (i = y.val & y.position),
                (y.position >>= 1),
                0 == y.position && ((y.position = e), (y.val = n(y.index++))),
                (r |= (0 < i ? 1 : 0) * a),
            ...
            if ((0 == u && ((u = Math.pow(2, h)), h++), c[l])) f = c[l];
            else {
              if (l !== p) return null;
              f = o + o.charAt(0);
            }
        ...
        (i.decode_url_query = function (t) {
          ...
          for (var n = t.split("&"), o = 0; o < n.length; o++) {
            ...
            if (1 <= r.length && r[0]) {
              ...
              2 === r.length ? (e[i] = decodeURIComponent(r[1])) : (e[i] = !0);
            }
          }
          return e;
        }),
        (i.decode_url = function (t) {
          t || (t = "");
          var e = t.split("#"),
            n = 1 < e.length ? e[1] : "",
            o = e[0].split("?"),
          ...
          return {
            path: o[0],
            query: i.decode_url_query(r),
            hash: i.decode_url_query(n),
          };
        }),
        i
      );
    })(),
    v = DYNALIST.SERVICES_URL || "https://dynlst.com",
    w = "/update",
    _ = 5e3,
    b = 1.5,
    A = 6e5,
  ...
  function j() {
    return g.decode_url(window.location.href).query.src || null;
  }
  var N = (function () {
      function t(t) {
        (this.uid = t),
      ...
      return (
        (t.prototype.request_run = function () {
          var t = Math.pow(b, this.failed) * _;
          A < t && (t = A),
            (t = Math.floor(t)),
        ...
        (t.prototype.run = function () {
          if (0 !== this.data.length) {
            var t = O();
            this.ts < t - T ? this.refresh() : this.push();
          }
        }),
        ...
        (t.prototype.track = function (t, e, n) {
          try {
            ...
            (e = e || {}),
              ...
              this.data.push({ type: t, ts: O(), data: e }),
              this.prune(),
        ...
        (t.prototype.prune = function () {
          if (!(this.data.length < k)) {
            ...
            0 < e && this.data.splice(0, e),
              this.data.length > x && this.data.splice(0, this.data.length - x);
          }
        }),
        (t.prototype.push = function () {
          var e = this;
          if (!this.working && 0 !== this.data.length) {
            this.length = Math.min(S, this.data.length);
            var t = this.data.slice(0, this.length);
            this.lz && ((t = JSON.stringify(t)), (t = m.compressToUTF16(t)));
            var n = {
                uid: this.uid,
                ts: this.ts_diff + O(),
                lz: this.lz,
        ...
        c = (function () {
          ...
          function o() {
            for (; e.length - n; ) {
              ...
              (e[n++] = i), 1024 == n && (e.splice(0, 1024), (n = 0));
            }
          }
          var r = (function () {
      ...
      return (
          ...
          reject: function (n) {
            if (this.state === s) {
              ...
              o
                ...
                : !u.suppressUncaughtRejectionError &&
                  a.console &&
                  a.console.log(
        ...
        (u.all = function (n) {
          var o = [],
            ...
            i = new u();
          function t(t, e) {
            (t && "function" == typeof t.then) || (t = u.resolve(t)),
              t.then(
                function (t) {
        ...
        ((a.Zousan = u).soon = c),
        (u.cb_resolve = function (e) {
          return function (t) {
            e && e(null, t);
          };
        }),
        (u.cb_reject = function (e) {
          return function (t) {
            e && e(t);
          };
        }),
  ...
  DYNALIST.IS_STANDALONE_MODE &&
    ((M = "desktop"),
    window.process && window.process.platform && (M = window.process.platform)),
    (window.Zousan = L),
    (DYNALIST.PLATFORM = M);
  var I = new N(DYNALIST.SESSION.identity);
  (window.ghost = I),
    (window.__ = I.track.bind(I)),
  ...
  var q = (function () {
          ...
          (e = this.events).trigger.apply(
            ...
            (function t() {
              ...
              var r = Array(e),
                i = 0;
              for (n = 0; n < o; n++)
                for (var s = arguments[n], a = 0, l = s.length; a < l; a++, i++)
                  r[i] = s[a];
              return r;
            })([t], n),
          );
      ...
      return (
        ...
        (t.prototype.off = function (t, e) {
          var n = this._,
            ...
            r = [];
          if (o && e)
            for (var i = 0; i < o.length; i++) o[i].fn !== e && r.push(o[i]);
          0 < r.length ? (n[t] = r) : delete n[t];
        }),
        (t.prototype.offref = function (t) {
          if (t) {
            var e = t.name,
              ...
              r = [];
            if (o && t)
              for (var i = 0; i < o.length; i++) o[i] !== t && r.push(o[i]);
        ...
        (t.prototype.trigger = function (t) {
          ...
          if (!this.disabled) {
            ...
            if (o) {
              o = o.slice();
              for (var r = 0; r < o.length; r++) this.tryTrigger(o[r], e);
            }
          }
        }),
    ...
    H = (function (n) {
      ...
      return (
        ...
        (t.prototype.enqueue = function (t, e, n, o, r) {
          ...
          if (!this.working && 0 !== this.queue.length) {
            ...
            if (((this.working = !0), this.offline))
              return (
                ...
                void this.handle_error("offline", i)
              );
            !(function t(e, n, o, r, i) {
              ...
              var a = "/api" + e;
              DYNALIST.IS_STANDALONE_MODE && (a = l + a),
                y && ((i.headers = i.headers || {}), (i.headers.DYS = y)),
                d(
                  a,
                  n,
                  function (t, e, n) {
              ...
              n,
              function (t) {
                return o.handle_response(t, r, i);
              },
              function (t, e, n) {
                return o.handle_error(e, i);
              },
              s,
            );
          }
        ...
        (t.prototype.handle_response = function (t, e, n) {
          ...
          try {
            if (t) {
              var o = t._mv,
                r = DYNALIST.VERSION;
              r && o && r < o && this.trigger("network_deprecated");
              var i = t._b;
              return (
                i &&
                  this.build !== i &&
                  ((this.build = i), this.trigger("build_changed", i)),
                t._code === u && this.trigger("network_deprecated"),
                t._code === a && this.trigger("network_logged_out"),
                void (t._code === s ? e && e(t) : n && n(t))
              );
            }
            n && n({ _code: c });
          } catch (t) {
    ...
    F = (function () {
      ...
      return (
        (t.prototype.get_modal_container_el = function (t) {
          return fish(".modal-container." + t);
        }),
        (t.prototype.get_modal_el = function (t) {
          return fish(".modal-container." + t + " > .modal");
        }),
        (t.prototype.get_open_modal_name = function () {
          return this.open_modal_name;
        }),
        (t.prototype.close_modal = function () {
          return (
        ...
        (t.prototype.open_modal = function (t) {
          this.close_modal();
          var e = this.get_modal_container_el(t);
          return (
            !!e &&
            ((this.open_modal_name = t),
            (this.open_modal_container_el = e),
            (this.open_modal_el = this.get_modal_el(t)),
            this.open_modal_container_el.addClass("is-shown"),
            !0)
          );
        }),
        (t.prototype.start_spinner = function () {
          var t = this.open_modal_el;
          t && t.addClass("loading");
        }),
        (t.prototype.stop_spinner = function () {
          var t = this.open_modal_el;
          t && t.removeClass("loading");
        }),
        t
      );
    })();
  ...
  /(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(
    ...
    ("MacIntel" === navigator.platform &&
      ...
      (/iPad|iPhone|iPod/.test(Y) && window.MSStream),
    document.documentElement.style,
    Y.toLowerCase().indexOf("firefox"),
    Y.toLowerCase().indexOf("edge"),
    -1 !== Y.indexOf("Safari") && Y.indexOf("Chrome");
  (function t() {
    return "ontouchstart" in window || navigator.maxTouchPoints;
  })();
  var U = {};
  function V(t) {
    return void 0 === U[t] && (U[t] = $(t)), U[t];
  }
  var z = (function () {
      function t() {}
      return (
        (t.create_popup = function (e) {
          return StripeCheckout.configure({
            key: DYNALIST.STRIPE_PUBLICKEY,
            image: "/assets/icon/apple-touch-icon-180x180.png",
            locale: "auto",
            token: function (t) {
              e && e(t.id);
            },
    ...
    W = (function () {
      function t() {
        (this.network = new H(!0)),
          (this.plan_id = ""),
          (this.promo_code = ""),
          (this.stripe_popup = z.create_popup(this.stripe_callback.bind(this))),
          this.hook_event();
      }
      return (
        (t.prototype.stripe_callback = function (t) {
          B.open_modal("payment-failed"),
            B.start_spinner(),
            this.network.enqueue(
              "/subscribe",
              { token: t, plan_id: this.plan_id, promo_code: this.promo_code },
              function (t) {
                setTimeout(function () {
                  t.charged
                    ? window.location.replace("/paid")
                    : window.location.replace("/resubscribed");
                }, 200);
              },
              function (t) {
                t && t._msg && V(".PaymentFailedMessage").text(t._msg).show(),
                  B.stop_spinner();
              },
            );
        }),
        (t.prototype.hook_event = function () {
          var t = this;
          $(window).on("popstate", function () {
            t.stripe_popup.close();
          });
        }),
        (t.prototype.open_stripe_popup = function (t, e) {
          (this.plan_id = t), (this.promo_code = e);
          var n = t === o ? "Dynalist Pro (monthly)" : "Dynalist Pro (yearly)";
          this.stripe_popup.open({
            description: n,
            name: "Dynalist",
            panelLabel: "Subscribe",
            email: DYNALIST.SESSION.email,
          });
        }),
        t
      );
    ...
    J = null,
    K = null,
    X = fish(".payment-promo-input"),
    G = new F(),
    Q = function () {
      var t = ot(),
        e = rt(),
        n = fish(".payment-error-message");
      n.setText(""), n.uHide(), tt(t, e);
    },
    tt = function (t, e) {
      fish(".payment-total-discount-section").uHide(),
        Z.enqueue("/price_check", { plan_id: t, promo_code: e }, et, nt);
    },
    et = function (t) {
      if (t.subtotal && (t.discount || t.tax)) {
        var e = D(t.subtotal);
        if (
          (fish(".payment-subtotal-amount").setText(e),
          t.discount && t.discount_desc)
        ) {
          var n = D(t.discount),
            o = t.discount_desc;
          fish(".payment-discount-amount").setText(n),
            fish(".payment-total-discount-name").setText(o),
            fish(".payment-total-discount-line").uShow(),
            K &&
              (fish(".PricingPage-appliedPromoCode").setText(K),
              fish(".PricingPage-appliedPromoName").setText(o),
              $(".PricingPage-promoAppliedSection").show());
        } else fish(".payment-total-discount-line").uHide();
        if (t.tax && t.tax_desc) {
          var r = D(t.tax),
            i = t.tax_desc;
          t.province && (i = t.province + " " + i),
            fish(".payment-tax-title").setText(i),
            fish(".payment-tax-amount").setText(r),
            fish(".payment-tax-line").uShow(),
            fish(".tax-clarification").uHide();
        } else
          fish(".payment-tax-line").uHide(), fish(".tax-clarification").uShow();
        fish(".payment-total-discount-section").uShow();
      } else fish(".payment-total-discount-section").uHide();
      var s = D(t.total);
      fish(".payment-total-amount").setText("$" + s);
    },
    nt = function (t) {
      if (t && t._msg) {
        var e = fish(".payment-error-message");
        e.setText(t._msg), e.uShow();
      }
    },
    ot = function () {
      return $(".billing_selection.active").data("plan");
    },
    rt = function () {
      var t = X.value;
      return "" === t && (t = null), t;
  ...
  $(document).ready(function () {
    V(".PricingPage-payButton").on("click", function (t) {
      t.preventDefault();
      var e = ot(),
        n = rt();
      e === o || e === r
        ? J
          ? J.open_stripe_popup(e, n)
          : trace("Stripe was not ready when user tries to pay")
        : trace("Invalid plan id on pricing page: " + e);
    }),
      V(".PricingPage-upgradeLink").on("click", function (t) {
        $(this).hasClass("is-loggedOut") ||
          (t.preventDefault(), G.open_modal("choose-plan"));
      }),
      $(".billing_selection").on("click", function () {
        $(this).hasClass("active") ||
          (fishAll(".billing_selection").forEach(function (t) {
            return t.removeClass("active");
          }),
          $(this).addClass("active"),
          Q());
      }),
      $(".js-apply-promo-code").on("click", function (t) {
        Q(), t.preventDefault();
      }),
      $(".js-remove-promo-code").on("click", function (t) {
        (X.value = ""), Q(), t.preventDefault();
      }),
      V(".js-cancel").on("click", function (t) {
        t.preventDefault(), G.close_modal();
      }),
      $(".close-btn, .modal-bg, .done-btn").on("click", function () {
        G.close_modal();
      }),
      ...
      (function () {
        var t = g.decode_url(window.location.href).query.promo;
        t && ((K = t), (X.value = t), Q());
      })(),
      window.stripe_setup_complete ? it() : (window.stripe_setup_callback = it),
      Q(),
      Z.enqueue("/user/referrals", {}, function (t) {
        if (t.hasOwnProperty("credits")) {
          var e = parseInt(t.credits);
          0 < e &&
            (fish(".pricing-page-remaining-credit").uShow(),
            fish(".pricing-page-remaining-credit-amount").setText(
              "$" + e / 100,
            ));
        }
      }),
