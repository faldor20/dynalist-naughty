...
!(function () {
    ...
    (window.createEl = function t(e, n, o) {
      ...
      return (
        ...
        u &&
          ...
          (h.value = u),
        p && h instanceof HTMLInputElement && (h.type = p),
        o && o(h),
        l && l.appendChild(h),
        h
      );
  ...
  (HTMLElement.prototype.on = t),
    ...
    (window.debounce = function (t, n, o, r, i) {
      var s = null,
        ...
        p = 0,
        l = function () {
          (s = null), i && (p = Date.now()), t.apply(a, c);
        },
        h = function (t, e) {
          t && s && clearTimeout(s), (!t && s) || (s = setTimeout(l, e));
        },
        f = function () {
          if (u) return f;
          if (!s || r) {
  ...
  var c = DYNALIST.SERVER_URL || "https://dynalist.io",
    i = (DYNALIST.PUSH_URL, 13),
    o = "/user/login",
    s = "/user/signup",
    r = "/user/resetpass",
    a = "/loginrequest/create",
    u = "/loginrequest/login",
    p = "/user/forgotpass",
    l = "/feedback",
    h = "/import/workflowy",
    f = "/user/google_login",
  ...
  var T = (function () {
      ...
      var s = {
            ...
            if (
              ...
              if (Object.prototype.hasOwnProperty.call(a, p)) {
                if (p.charCodeAt(0) < 256) {
                  ...
                  for (r = p.charCodeAt(0), o = 0; o < 8; o++)
                    (g = (g << 1) | (1 & r)),
                      y == e - 1 ? ((y = 0), d.push(n(g)), (g = 0)) : y++,
                      (r >>= 1);
                } else {
                  for (r = 1, o = 0; o < f; o++)
                    (g = (g << 1) | r),
                      y == e - 1 ? ((y = 0), d.push(n(g)), (g = 0)) : y++,
                      (r = 0);
                  for (r = p.charCodeAt(0), o = 0; o < 16; o++)
                    (g = (g << 1) | (1 & r)),
                      y == e - 1 ? ((y = 0), d.push(n(g)), (g = 0)) : y++,
                      (r >>= 1);
                }
                0 == --l && ((l = Math.pow(2, f)), f++), delete a[p];
              } else
                for (r = s[p], o = 0; o < f; o++)
                  (g = (g << 1) | (1 & r)),
                    y == e - 1 ? ((y = 0), d.push(n(g)), (g = 0)) : y++,
        ...
        _decompress: function (t, e, n) {
          ...
          for (o = u[3] = c, d.push(c); ; ) {
            ...
            if ((0 == p && ((p = Math.pow(2, h)), h++), u[c])) f = u[c];
            else {
              if (c !== l) return null;
              f = o + o.charAt(0);
            }
    ...
    O = DYNALIST.SERVICES_URL || "https://dynlst.com",
    L = "/update",
    j = 5e3,
    C = 1.5,
    x = 6e5,
  ...
  function R() {
    return S.decode_url(window.location.href).query.src || null;
  }
  var Y = (function () {
      function t(t) {
        (this.uid = t),
          ...
          (this.lz = !0),
          (this.timer = null),
          (this._request_run = debounce(this.run, j));
      }
      return (
        (t.prototype.request_run = function () {
          var t = Math.pow(C, this.failed) * j;
          x < t && (t = x),
            (t = Math.floor(t)),
        ...
        (t.prototype.run = function () {
          if (0 !== this.data.length) {
            var t = D();
            this.ts < t - N ? this.refresh() : this.push();
          }
        }),
        ...
        (t.prototype.track = function (t, e, n) {
          try {
            ...
            (e = e || {}),
              ...
              this.data.push({ type: t, ts: D(), data: e }),
              this.prune(),
        ...
        (t.prototype.prune = function () {
          if (!(this.data.length < M)) {
            ...
            0 < e && this.data.splice(0, e),
              this.data.length > I && this.data.splice(0, this.data.length - I);
          }
        }),
        (t.prototype.push = function () {
          var e = this;
          if (!this.working && 0 !== this.data.length) {
            this.length = Math.min(P, this.data.length);
            var t = this.data.slice(0, this.length);
            this.lz && ((t = JSON.stringify(t)), (t = T.compressToUTF16(t)));
            var n = {
                uid: this.uid,
                ts: this.ts_diff + D(),
                lz: this.lz,
      ...
      return (
          ...
          resolve: function (n) {
            if (this.state === s) {
              ...
              (this.state = c),
                ...
                o.c &&
                  u(function () {
                    for (var t = 0, e = o.c.length; t < e; t++) l(o.c[t], n);
                  });
            }
          },
          reject: function (n) {
            if (this.state === s) {
              ...
              o
                ...
                : !p.suppressUncaughtRejectionError &&
                  a.console &&
                  a.console.log(
        ...
        (p.all = function (n) {
          var o = [],
            ...
            i = new p();
          function t(t, e) {
            (t && "function" == typeof t.then) || (t = p.resolve(t)),
              t.then(
                function (t) {
        ...
        ((a.Zousan = p).soon = u),
        (p.cb_resolve = function (e) {
          return function (t) {
            e && e(null, t);
          };
        }),
        (p.cb_reject = function (e) {
          return function (t) {
            e && e(t);
          };
        }),
  ...
  DYNALIST.IS_STANDALONE_MODE &&
    ((z = "desktop"),
    window.process && window.process.platform && (z = window.process.platform)),
    (window.Zousan = U),
    (DYNALIST.PLATFORM = z);
  var H = new Y(DYNALIST.SESSION.identity);
  (window.ghost = H),
    (window.__ = H.track.bind(H)),
  ...
  /(android|bb\d+|meego).+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows ce|xda|xiino|android|ipad|playbook|silk/i.test(
    ...
    ("MacIntel" === navigator.platform &&
      ...
      (/iPad|iPhone|iPod/.test(V) && window.MSStream),
    document.documentElement.style,
    V.toLowerCase().indexOf("firefox"),
    V.toLowerCase().indexOf("edge"),
    -1 !== V.indexOf("Safari") && V.indexOf("Chrome");
  (function t() {
  ...
  var X = (function () {
          ...
          (e = this.events).trigger.apply(
            ...
            (function t() {
              ...
              var r = Array(e),
                i = 0;
              for (n = 0; n < o; n++)
                for (var s = arguments[n], a = 0, c = s.length; a < c; a++, i++)
                  r[i] = s[a];
              return r;
            })([t], n),
          );
          ...
          if (!this.working && 0 !== this.queue.length) {
            ...
            !(function t(e, n, o, r, i) {
              ...
              DYNALIST.IS_STANDALONE_MODE && (a = c + a),
                E && ((i.headers = i.headers || {}), (i.headers.DYS = E)),
                A(
                  a,
                  n,
                  function (t, e, n) {
          ...
          try {
            if (t) {
              ...
              return (
                ...
                t._code === v && this.trigger("network_deprecated"),
                t._code === _ && this.trigger("network_logged_out"),
                void (t._code === y ? e && e(t) : n && n(t))
              );
            }
            n && n({ _code: w });
          } catch (t) {
    ...
    ot = (function () {
      ...
      return (
        ...
        (t.prototype.api_enqueue = function (t, e, n, o) {
          ...
          return (
            this.network.enqueue(
              ...
              e,
              function (t) {
                r.end_working(), i.resolve(t);
              },
              function (t) {
                r.end_working(),
                  t && t._captcha && r.try_load_captcha(),
                  r.show_response_error_message(t, n),
                  i.reject(t);
              },
              o,
            ),
        ...
        (t.prototype.api_login_request_create = function (t) {
          return this.api_enqueue(a, { source: t }, "Failed to request login.");
        }),
        ...
        (t.prototype.api_signup = function (t, e, n, o, r) {
          return this.api_enqueue(
            s,
            { name: t, email: e, password: n, copy_document_id: o, captcha: r },
            "Failed to signup.",
          );
        }),
    ...
    rt = (function (r) {
      function t(t, e) {
        ...
        (n.success_callback = e),
          (n.$email_el = n.container.find(".EmailField")),
          (n.$password_el = n.container.find(".PasswordField")),
          (n.$login_btn_el = n.container.find(".js-login")),
          n.$login_btn_el.on("click", function (t) {
            t.preventDefault(), n.attempt_login();
          }),
          n.$password_el.on("keydown", function (t) {
            t.keyCode === i && n.attempt_login();
          });
        var o = DYNALIST.AUTOFILL_EMAIL;
        return (
          o && n.$email_el.val(o),
          n.$email_el.val() ? n.$password_el.focus() : n.$email_el.focus(),
          n
        );
      }
      return (
        W(t, r),
        (t.prototype.attempt_login = function () {
          var e = this;
          if (!this.working) {
            var t = this.$email_el.val(),
              n = this.$password_el.val(),
              o = this.try_get_captcha();
            this.api_login(t, n, o).then(
              function (t) {
                e.success_callback
                  ? e.success_callback(t.session)
                  : (e.start_working(), setTimeout(Z, 200));
              },
              function (t) {
                return e.show_response_error_message(t, "Failed to login.");
              },
            );
          }
        }),
    ...
    st = (function () {
      function t() {
        var t = this;
        (this.google_loaded = K()),
          (this.google_error = null),
          this.initialize(),
          window[it].push(function () {
            t.init();
          });
      }
      return (
        (t.prototype.initialize = function () {
          return (
            !!window[it] ||
            ((window[it] = K()),
            J("https://apis.google.com/js/api:client.js?onload=" + it),
            !1)
          );
        }),
    ...
    ct = (function (n) {
      function t(t) {
        var e = n.call(this, t) || this;
        return (e.google_login = new st()), e;
      }
      return (
        W(t, n),
        (t.prototype.attempt_google_login = function () {
          ...
          this.google_login.on_ready(function () {
            var t = r.google_login.get_error();
            t
              ? r.show_error_message(t)
              : r.google_login.login(
                  function (t) {
      ...
      return (
        ...
        (t.prototype.login_success = function (t) {
          ...
          this.api_google_login(t.id_token, t.captcha).then(function () {
            e.start_working(), setTimeout(Z, 300);
          });
        }),
        t
      );
    ...
    pt =
      ...
      (function (a) {
        function t(t, e, n, o) {
          ...
          if (
            ((r.env = e),
            (r.success_callback = n),
            e.is("mobile") && e.is("ios"))
          ) {
            var i = t.get(0),
              s = i.find(".js-apple-signin");
            if (!s)
              s = i
  ...
  (function (i) {
    function t(t, e, n, o) {
      var r = i.call(this, t, e, n, "Sign in with Apple") || this;
      return (r.loginManager = o), r;
    }
    W(t, i),
      (t.prototype.login_success = function (t) {
        var e = this;
      ...
      (t.prototype.onAppleLoginSuccess = function (t, e, n) {
        var o = this,
          r = this.try_get_captcha();
        this.api_apple_login(t, e, r).then(function (t) {
    ...
    (function (i) {
      function t(t, e, n, o) {
        var r = i.call(this, t, e, n, "Sign up with Apple") || this;
        return (r.signupManager = o), r;
      }
      W(t, i),
        (t.prototype.login_success = function (t) {
          var e = this;
