...
!(function () {
  ...
  function Y() {
    return T.decode_url(window.location.href).query.src || null;
  }
  var R = (function () {
      function t(t) {
        (this.uid = t),
      ...
      return (
        ...
        (t.prototype.run = function () {
          if (0 !== this.data.length) {
            var t = D();
            this.ts < t - x ? this.refresh() : this.push();
          }
        }),
  ...
  DYNALIST.IS_STANDALONE_MODE &&
    ...
    (window.Zousan = U),
    (DYNALIST.PLATFORM = z);
  var H = new R(DYNALIST.SESSION.identity);
  (window.ghost = H),
      ...
      return (
        ...
        (t.prototype.attempt_signup = function () {
          ...
          if (!this.working) {
            ...
            this.api_signup(e, n, o, this.document_id_to_copy, r).then(
              function () {
                t.container
                  .find(
      ...
      return (
        (t.prototype.initialize = function () {
          return (
            !!window[it] ||
            ((window[it] = tt()),
            Q("https://apis.google.com/js/api:client.js?onload=" + it),
            !1)
          );
        }),
        ...
        W(t, e),
          (t.prototype.login_success = function (t) {
            ...
            this.api_google_login(t.id_token, t.captcha).then(function () {
              e.start_working(), setTimeout(X, 300);
            });
          });
      })(ct),
      (function (e) {
  ...
  $(document).ready(function () {
    ...
    new rt(t, null, DYNALIST.COPY_DOCUMENT), new ut(t);
  });
})();
